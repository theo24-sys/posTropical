...
import { MenuItem, Category, User, SaleTransaction } from './types';
...
export const KITCHEN_RECIPES: Record<string, { invId: string; amount: number }[]> = {
  ...
  't_matcha': [
    { invId: 'inv_matcha_powder', amount: 10 },
  ],
  'ice_mat_cla': [
    { invId: 'inv_matcha_powder', amount: 15 },
  ],
  'ice_mat_van': [
    { invId: 'inv_matcha_powder', amount: 15 },
  ],
  ...
  'ice_mat_frap': [
    { invId: 'inv_matcha_powder', amount: 20 },
  ],
};
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    price: 500,
    category: Category.ICED_COFFEE,
    image: 'https://images.unsplash.com/photo-1536555198118-21915ea621fa?auto=format&fit=crop&w=600&q=80',
    stock: 50, lowStockThreshold: 10
  },
  {
    id: 'ice_mat_van',
  ...
  {
    id: 'pz_bbq_beef_m',
    name: 'BBQ Beef Pizza (Medium)',
    price: 1250,
    category: Category.PIZZA,
    image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=600&q=80',
    description: 'Pizza sauce, bbq sauce, beef, onions, tomatoes, mozzarella cheese, oregano, basil',
    stock: 20, lowStockThreshold: 5
  },
  {
    id: 'pz_bbq_beef_l',
    name: 'BBQ Beef Pizza (Large)',
    price: 1600,
    category: Category.PIZZA,
    image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=600&q=80',
    description: 'Pizza sauce, bbq sauce, beef, onions, tomatoes, mozzarella cheese, oregano, basil',
  ...
  },
  {
    ...
    description: 'Pizza sauce, bbq sauce, chicken, onions, tomatoes, mozzarella cheese, oregano, basil',
    stock: 20, lowStockThreshold: 5
  },
  {
    id: 'pz_bbq_chick_l',
  ...
  },
  {
    ...
    description: 'Pizza sauce, bbq sauce, bacon/sausage, pineapple cubes, onions, tomatoes, mozzarella cheese, oregano, basil',
    stock: 20, lowStockThreshold: 5
  },
  {
    id: 'pz_hawaiian_l',
  ...
  },
  {
    ...
    description: 'Pizza sauce, onions, tomatoes slices, sweet corn, mozzarella cheese, oregano, basil',
    stock: 20, lowStockThreshold: 5
  },
  {
    id: 'pz_margherita_l',
