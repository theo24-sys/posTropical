                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-8 h-8 rounded-full bg-white border border-gray-100 flex items-center justify-center hover:bg-gray-50 shadow-sm transition-transform active:scale-90"
                      >
                        <Minus size={14} />
                      </button>
        ...
        <div className="pt-8 border-t border-gray-100 space-y-8">
          ...
          <div className="flex bg-gray-50 p-1.5 rounded-2xl border border-gray-100">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-xl text-sm font-black transition-all ${
                orderType === 'Dine-in' ? 'bg-white text-[#4B3621] shadow-md' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-xl text-sm font-black transition-all ${
                orderType === 'Take Away' ? 'bg-white text-[#4B3621] shadow-md' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
