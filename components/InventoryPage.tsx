...
export const InventoryPage: React.FC<InventoryPageProps> = ({ inventory, onUpdateStock, onRefresh }) => {
  ...
  const getCategoryIcon = (cat: InventoryCategory) => {
    switch (cat) {
      ...
      case 'BITINGS': case 'MAIN COURSES': case 'BURGERS / BURRITOS & SANDWICHES': return <Beef size={20} />;
      case 'SANDWICHES': case 'SIDES': return <Layers size={20} />;
      case 'BAKERY & PASTRIES': case 'DESSERTS': return <Cake size={20} />;
      default: return <GlassWater size={20} />;
    }
  };
