...
-- PIZZA
('pz_bbq_beef_m', 'BBQ Beef Pizza (Medium)', 1250, 'PIZZA', 'Pizza sauce, bbq sauce, beef, onions, tomatoes, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=600&q=80'),
('pz_bbq_beef_l', 'BBQ Beef Pizza (Large)', 1600, 'PIZZA', 'Pizza sauce, bbq sauce, beef, onions, tomatoes, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=600&q=80'),
('pz_bbq_chick_m', 'BBQ Chicken Pizza (Medium)', 1250, 'PIZZA', 'Pizza sauce, bbq sauce, chicken, onions, tomatoes, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=600&q=80'),
('pz_bbq_chick_l', 'BBQ Chicken Pizza (Large)', 1600, 'PIZZA', 'Pizza sauce, bbq sauce, chicken, onions, tomatoes, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=600&q=80'),
('pz_hawaiian_m', 'Hawaiian Pizza (Medium)', 1250, 'PIZZA', 'Pizza sauce, bbq sauce, bacon/sausage, pineapple cubes, onions, tomatoes, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?auto=format&fit=crop&w=600&q=80'),
('pz_hawaiian_l', 'Hawaiian Pizza (Large)', 1600, 'PIZZA', 'Pizza sauce, bbq sauce, bacon/sausage, pineapple cubes, onions, tomatoes, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?auto=format&fit=crop&w=600&q=80'),
('pz_margherita_m', 'Margherita Pizza (Medium)', 950, 'PIZZA', 'Pizza sauce, onions, tomatoes slices, sweet corn, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&w=600&q=80'),
('pz_margherita_l', 'Margherita Pizza (Large)', 1250, 'PIZZA', 'Pizza sauce, onions, tomatoes slices, sweet corn, mozzarella cheese, oregano, basil', 20, 5, 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&w=600&q=80');